...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]'); // showMoreStyles('.button-styles', '.styles-2'); - для предыдущей версии
  ...
  /* , '.accordion-block' */
  ); //второй селектор для другой реализации модуля accordion
...
var changeModalState = function changeModalState(state) {
  var artSize = document.querySelectorAll('#size'),
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      markAll = document.querySelectorAll('.portfolio-block'),
  ...
  menu.addEventListener('click', function (e) {
    ...
    if (target.classList[0] == 'all') {
      typeFilter(markAll);
    } else if (target.classList[0] == 'grandmother' || target.classList[0] == 'granddad') {
      typeFilter();
    } else {
      var markSel = [];
      markAll.forEach(function (pic) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      if (item.classList.contains('calc_form')) {
        ...
        formData.append('total_price', +resultBlock.textContent);
      }
...
var modals = function modals() {
  ...
  /* переменная хранит инфо о том, былал ли нажата хотя бы одна кнопка */
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // условие для старых браузеров
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    var img = block.querySelector('img'); // img.classList.add('animated', 'fadeInDown');
  ...
  function hideImg(block) {
    var img = block.querySelector('img'); // img.classList.remove('animated', 'fadeInDown');
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); //   cards = document.querySelectorAll(styles); - для предыдущей версии
